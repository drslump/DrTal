...
namespace DrTal::Storage;

require_once DRTAL_INCLUDE_BASE . 'DrTal/Storage.php';


/*
 Class: DrTal::Storage::File
 ...
 Extends:
    <DrTal::Storage>
*/
class File extends DrTal::Storage
{
