...
/*
 ...
 See also:
    <DrTal_Storage_File>, <DrTal_Storage_String>
*/
    ...
    */
    ...
    /*
     ...
     Arguments:
        ...
        $tplClass   - The <DrTal_Template> class name to instantiate
     
     Returns:
        A <DrTal_Template> object if successful, false if not
        
     Throws:
        <DrTal_Storage_Exception> if an unexpected error was found
    */
