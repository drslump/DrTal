...
class TalDefineTest extends PHPUnit_Framework_TestCase 
{
    ...
    function testMulti()
    {
        $tpl = DrTal::load('input/tal-define.01.html');
        $res = $tpl->execute(false);
        $res = trim_string($res);
    ...
    {
        $tpl = DrTal::load('input/tal-define.02.html');
        $res = $tpl->execute(false);
        $res = trim_string($res);
    ...
    {
        $tpl = DrTal::load('input/tal-define.03.html');
        $res = $tpl->execute(false);
        $res = trim_string($res);
    ...
    {
        $tpl = DrTal::load('input/tal-define.04.html');
        $res = $tpl->execute(false);
        $res = trim_string($res);
    ...
    {
        $tpl = DrTal::load('input/tal-define.05.html');
        $res = $tpl->execute(false);
        $res = trim_string($res);
    ...
    {
        $tpl = DrTal::load('input/tal-define.06.html');
        $res = $tpl->execute(false);
        $res = trim_string($res);
    ...
    {
        $tpl = DrTal::load('input/tal-define.07.html');
        $res = $tpl->execute(false);
        $res = trim_string($res);
    ...
    {
        $tpl = DrTal::load('input/tal-define.08.html');
        $res = $tpl->execute(false);
        $res = trim_string($res);
    ...
    {
        $tpl = DrTal::load('input/tal-define.09.html');
        $res = $tpl->execute(false);
        $res = trim_string($res);
    ...
    {
        $tpl = DrTal::load('input/tal-define.10.html');
        $tpl->fname = 'Roger';
        $res = $tpl->execute(false);
        $res = trim_string($res);
    ...
    {
        $tpl = DrTal::load('input/tal-define.11.html');
    ...
    {
        $tpl = DrTal::load('input/tal-define.12.html');
        //$tpl->setOutputMode(PHPTAL::XML);
        $res = $tpl->execute(false);
        $res = trim_string($res);
    ...
    function testDefineGlobal()
    {
        ...
        $tpl = DrTal::load('input/tal-define.13.html');
        $res = trim_string($tpl->execute(false));
        $this->assertEquals($exp, $res);
    }
    ...
    function testDefineAlter()
    {
        ...
        $tpl = DrTal::load('input/tal-define.14.html');
        $res = trim_string($tpl->execute(false));
        $this->assertEquals($exp, $res);
    }
}
