...
class TalContentTest extends PHPUnit_Framework_TestCase 
{
    function testSimple()
    {
        $tpl = DrTal::load('input/tal-content.01.html');
        $res = trim_string($tpl->execute(false));
        echo $tpl->getScriptStream() . PHP_EOL;
    ...
    function testVar()
    {
        $tpl = DrTal::load('input/tal-content.02.html');
    ...
    {
        $tpl = DrTal::load('input/tal-content.03.html');
    ...
    {
        $tpl = DrTal::load('input/tal-content.04.html');
        $res = trim_string($tpl->execute(false));
    ...
    {
        $tpl = DrTal::load('input/tal-content.05.html');
        $res = trim_string($tpl->execute(false));
    ...
    function testChain()
    {
        $tpl = DrTal::load('input/tal-content.06.html');
        $res = trim_string($tpl->execute(false));
